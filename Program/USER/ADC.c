...
*/
//========================================================================
// 函数: u8	Get_ADC8bitResult(u8 channel)
// 描述: 查询法读一次ADC结果.
// 参数: channel: 选择要转换的ADC.
// 返回: 8位ADC结果.
// 版本: V1.0, 2012-10-22
//========================================================================
u8	Get_ADC8bitResult(u8 channel)	//channel = 0~7
{
	u8	i;

	if(channel > ADC_CH7)	return	255;	//错误,返回255,调用的程序判断	
	ADC_RES = 0;
	ADC_RESL = 0;
